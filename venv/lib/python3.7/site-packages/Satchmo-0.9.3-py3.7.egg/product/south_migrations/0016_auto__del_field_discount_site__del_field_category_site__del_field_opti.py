...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Discount.site'
        db.delete_column('product_discount', 'site_id')

        # Deleting field 'Category.site'
        db.delete_column('product_category', 'site_id')

        # Deleting field 'OptionGroup.site'
        db.delete_column('product_optiongroup', 'site_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Discount.site'
        raise RuntimeError("Cannot reverse this migration. 'Discount.site' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Discount.site'
        db.add_column('product_discount', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Category.site'
        raise RuntimeError("Cannot reverse this migration. 'Category.site' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Category.site'
        db.add_column('product_category', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'OptionGroup.site'
        raise RuntimeError("Cannot reverse this migration. 'OptionGroup.site' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'OptionGroup.site'
        db.add_column('product_optiongroup', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site']),
                      keep_default=False)
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Product.site'
